...
WindowsBuild {
    ...
    QGC_INSTALLER_ICON          = "$$SOURCE_DIR\\deploy\\windows\\ArgosdyneLogo.ico"
...
HEADERS += \
    ...
    src/Settings/GeoZoneMakeViewSettings.h \
...
SOURCES += \
    ...
    src/MissionManager/YellowScanInitPathComplexItem.cc \
    ...
    src/Settings/GeoZoneMakeViewSettings.cc \
...
LIBS += -L$$PWD/src/CGAL/lib/mpfr.lib \
    ...
    -L$$PWD/src/OpenSSL/lib/VC/x64/MD \
            -llibssl \
            -llibcrypto
...
AndroidBuild {
    ...
    QT += androidextras
    HEADERS += src/Login/AndroidSecurityStorage.h
    SOURCES += src/Login/AndroidSecurityStorage.cpp
