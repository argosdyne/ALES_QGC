    ...
    Column {
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                text: _viewproPip ? capitalize(_viewproPip.enumOrValueString) : ""
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    if(_viewproPip.enumIndex === _viewproPip.enumStrings.length - 1) {
                        _viewproPip.enumIndex = 0
                    } else {
                        _viewproPip.enumIndex = _viewproPip.enumIndex + 1
                    }
                }
            }
        }
        // Viewpro thermal switch color palette
        Rectangle {
            width:          zoomControl.width
            height:         zoomControl.height
            color:          qgcPal.window
            visible:        _viewproColorPalette
            radius:         height/10
            anchors.right:  parent.right
            QGCLabel {
                anchors.centerIn: parent
                text: _viewproColorPalette ? _viewproColorPalette.enumOrValueString : ""
                verticalAlignment: Text.AlignVCenter
                horizontalAlignment: Text.AlignHCenter
                font.pointSize: ScreenTools.mediumFontPointSize
            }
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    if(_viewproColorPalette.enumIndex === _viewproColorPalette.enumStrings.length - 1) {
                        _viewproColorPalette.enumIndex = 0
                    } else {
                        _viewproColorPalette.enumIndex = _viewproColorPalette.enumIndex + 1
                    }
                }
            }
        }
        ...
        Item {
            ...
            QGCFlickable {
                ...
                Column {
                    ...
                    Repeater {
                        model:      _camera && _camera.paramComplete ? _camera.activeSettings : []
                        Item {
                            width:   repCol.width
                            ...
                            Column {
                                ...
                                Row {
                                    ...
                                    QGCSlider {
                                        ...
                                        onValueChanged: {
                                            if(visible) parent.parent._fact.value = value
                                        }
                                    }
                                    CustomOnOffSwitch {
                                        id:         customSwitch
                                        ...
                                        anchors.verticalCenter: parent.verticalCenter
                                        Component.onCompleted: {
                                            checked = parent.parent._fact.value
                                        }
                                        Connections {
                                            target: repCol._fact
                                            onRawValueChanged: {
                                                customSwitch.checked = repCol._fact.value
                                            }
                                        }
                                    }
                                }
