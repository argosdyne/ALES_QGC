...
static int ax88179_bind(struct usbnet *dev, struct usb_interface *intf)
{
	...
	*tmp = 0x52;
	...
	/* Disable RX checksum offload. Let the kernel validate RX checksums. */
	pr_info_once("ax88179_178a: RX checksum offload disabled for QCM RTSP/UDP validation\n");
	*tmp = 0;
	ax88179_write_cmd(dev, AX_ACCESS_MAC, AX_RXCOE_CTL, 1, 1, tmp);
...
{
	/* Do not trust AX88179 RX checksum metadata on this platform. */
	pr_info_once("ax88179_178a: forcing CHECKSUM_NONE on RX packets\n");
