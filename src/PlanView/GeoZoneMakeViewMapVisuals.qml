...
Item {
    ...
    Instantiator {
        ...
        delegate : GeoZoneMapPolygonVisuals {
            parent:             _root
            mapControl:         map
            mapPolygon:         object
            borderWidth:        1//object.inclusion ? _borderWidthInclusion : _borderWidthExclusion
            borderColor:        "black" //object.colorInclusion
            interiorColor:      "green" //object.colorInclusion
            interiorOpacity:     object.inclusion ? _interiorOpacityInclusion : _interiorOpacityExclusion
            interactive:        true //_root.interactive && mapPolygon && mapPolygon.interactive

            Component.onCompleted: {

                //object.appendVertices(defaultPolygonVertices())
            }
        }
    }
    ...
    //     parent:             _root
    //     mapControl:         map
    //     mapPolygon:         _polygons
    //     borderWidth:        1//object.inclusion ? _borderWidthInclusion : _borderWidthExclusion
    //     borderColor:        "black" //object.colorInclusion
    //     interiorColor:      "green" //object.colorInclusion
    //     interiorOpacity:     _interiorOpacityInclusion
    //     interactive:        true //_root.interactive && mapPolygon && mapPolygon.interactive
    ...
    Component.onCompleted: {
        console.log("asdasdasdasfa");
        //_polygons.appendVertices(defaultPolygonVertices())
