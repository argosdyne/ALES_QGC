...
public:
    ...
    Q_INVOKABLE void loadFromUsbFile(const QString& filename, const QString& usbRootPath);
...
private:
    ...
    bool _loadFromFile              (const QString& filename, const QString& validationBasePath);
