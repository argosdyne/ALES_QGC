...
Rectangle {
    ...
    //         var point = Qt.point(itemDragger.x + _touchMarginHorizontal + itemIndicator.anchorPoint.x,
    //                              itemDragger.y + _touchMarginVertical + itemIndicator.anchorPoint.y)
    ...
    //         // ✨ 위치 보정 (Drag와 itemIndicator의 동기화)
    //         itemDragger.x = itemIndicator.x - _touchMarginHorizontal
    //         itemDragger.y = itemIndicator.y - _touchMarginVertical
    //     }
    // }
