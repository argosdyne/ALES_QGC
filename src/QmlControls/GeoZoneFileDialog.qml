...
Item {
    ...
    // only for geozone
    property var fixedFolders: _appSettings ? [ _appSettings.geoZoneSavePath + "/Custom", _appSettings.geoZoneSavePath + "/DFS" ] : []
    ...
    GeoZoneFileDialogController { id: controller }
    ...
    Component {
        ...
        QGCPopupDialog {
            ...
            Column {
                ...
                Repeater {
                    id:     fileRepeater
                    model:  controller.getFilesFromFolders(fixedFolders, _rgExtensions)
                    ...
                    FileButton {
                        ...
                        onClicked: {
                            ...
                            _root.acceptedForLoad(modelData)
                        }
                        ...
                        QGCMenu {
                            ...
                            QGCMenuItem {
                                ...
                                onTriggered: {
                                    ...
                                    fileRepeater.model = controller.getFilesFromFolders(fixedFolders, _rgExtensions)
                                }
                            }
                        }
                    }
                ...
                Repeater {
                    ...
                    FileButton {
                        ...
                        onClicked: {
                            ...
                            //root.acceptedForSave(controller.fullyQualifiedFilename(folder, modelData))
                            _root.acceptedForLoad(modelData)
                        }
