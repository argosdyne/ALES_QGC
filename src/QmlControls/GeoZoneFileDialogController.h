...
#ifndef GeoZoneFileDialogController_H
#define GeoZoneFileDialogController_H
...
Q_DECLARE_LOGGING_CATEGORY(GeoZoneFileDialogControllerLog)

class GeoZoneFileDialogController : public QObject
{
    Q_OBJECT
...
public:
    ...
    Q_INVOKABLE QStringList getFilesFromFolders(
